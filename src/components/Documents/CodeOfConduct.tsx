export const CodeOfConduct = () => (
	<>
		...
		<p>
			All communication should be appropriate for a professional audience, including people of many different backgrounds. Discriminatory language and imagery is not
			appropriate for this community and its events, including Toronto JS Social, JS Tech Talk, JS Code Club and JS Workshop.
		</p>
		<p>
			We do not tolerate bullying, name-calling, personal attacks, harassment, threats, or discriminatory behaviour that can create an unsafe environment for members from
			marginalized groups, including discriminatory jokes, suggestions of intellectual superiority or intolerance towards accessibility or diversity efforts.
		</p>
		<p>
			Members violating these rules may be asked to leave an event or denied access to the Toronto JS online community at the sole discretion of the organizers.
		</p>
		...
		<ul>
			...
			<li>
				<a href='https://medium.com/thinking-is-hard/guidelines-for-fruitful-dialogue-9d7d0b46da89'>Disagreeing productively</a>
			</li>
		...
		<ul>
			<li>
				...
				gender, race or religion. Subtle -isms and small mistakes made in conversation are not code of conduct violations. However, repeating something after it has been
				pointed out to you that you broke a social rule, or antagonizing or arguing with someone who has pointed out your subtle -ism is considered unwelcoming behavior,
				and is not allowed at Toronto JS.
			</li>
			<li>
		...
		<p>
			Be careful in the words that you choose. Excessive swearing, trolling or the incessant posting of inflammatory comments, sexist, homophobic, transphobic, racist,
			ableist or otherwise exclusionary jokes can be offensive and hostile towards those around you.
		</p>
		<p>
			If a participant engages in behavior that violates our anti-harassment policy or code of conduct, Toronto JS organizers may take any action they deem appropriate,
			including warning the offender or expulsion from the event, gathering or Toronto JS online community.
		</p>
		<p>
			Moderators have the right and responsibility to remove comments or other contributions that are not aligned to this Code of Conduct, or to suspend temporarily or
			permanently any members for other behaviors that they deem inappropriate, threatening, offensive, or harmful.
		</p>

		<h2>Social Rules</h2>
		<p>
			In addition to having a code of conduct as an anti-harassment policy, we have a small set of{' '}
			<a href='https://www.recurse.com/manual#sub-sec-social-rules'>social rules</a> we follow. We, the organizers, have adapted rules from
			<a href='https://www.recurse.com/'>the Recurse Center</a>{' '}
			because we felt that they contribute enormously to a supportive, productive, and fun learning environment, and we'd like Toronto JS to share that environment.
		</p>
		<p>
			These rules are intended to be lightweight, and to make more explicit certain social norms that are normally implicit. Most of our social rules really boil down to
			"don't be a jerk" or "don't be annoying." Of course, almost nobody sets out to be a jerk or annoying, so telling people not to be jerks isn't a very productive
		...
		<p>
			...
			surprise, it's usually to make them feel better about themselves and others feel worse. And even when that's not the intention, it's almost always the effect. As you've
		...
		<p>
			Subtle -isms are small things that make others feel unwelcome, things that we all sometimes do by mistake. For example, saying "It's so easy my grandmother could do it"
			is a subtle -ism. Like the other three social rules, this one is often accidentally broken. Like the other three, it's not a big deal to mess up - you just apologize
			and move on.
		</p>
		<p>
			If you see a subtle -ism happen at Toronto JS, you can point it out to the relevant person, either publicly or privately, or you can ask one of organizers to say
			something. After this, we ask that all further discussion move off of public channels. If you are a third party, and you don't see what could be biased about the
			comment that was made, feel free to talk to the organizers. Please don't say, "Comment X wasn't homophobic!" Similarly, please don't pile on to someone who made a
			mistake. The "subtle" in "subtle -isms" means that it's probably not obvious to everyone right away what was wrong with the comment.
		</p>
		...
		<p>
			We want Toronto JS to be a space with as little bigotry or oppression as possible. Therefore, if you see sexism, racism, or outrage at such things outside Toronto JS
			and also do not experience such issues directly yourself, please don't bring it in for discussion. For example, don't start a discussion of the latest offensive comment
			from Random Tech Person Y. For many people, especially those who may have spent time in unpleasant work environments, these conversations can turn into long threads
			that become distracting and disheartening. At Toronto JS, we want to remove as many distractions as possible for marginalized people so they can focus on enjoying
			programming. There are many places in the world to discuss and debate these issues, but there are few where they can avoid them. We want Toronto JS to be one of those
			places.
		</p>
		...
		<p>
			If someone says, "hey, you just feigned surprise," or "that's subtly sexist," don't worry. Just apologize, reflect for a second, and move on. It doesn't mean you're a
			"bad" person, or even a "bad" community member. As we said above, these rules are meant to be guidelines. We've all done these things before.
		</p>
		<p>
			Sometimes pointing out that someone broke a social rule can be challenging or feel awkward. If you don't feel comfortable pointing out to someone that they are
			consistently breaking a social rule, ask an organizer or moderator for help.
		</p>
		<p>
		...
		<p>
			...
			<a href='https://torontojs.com/p/volunteers'>a member of Toronto JS organizers or volunteer staff</a>. You can use the below form to contact us, with or without your
			name.
		</p>
		<p>
			Organizers, moderators and volunteers will be happy to do whatever we can to help those experiencing harassment to feel safe during events and at all times in our
