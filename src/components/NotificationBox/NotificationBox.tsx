...
function SuccessIcon() {
  return (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      />
      <path d='M9 11L12 14L22 4' stroke='#06D6A0' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
}
  ...
  return (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M12 16V12' stroke='#3388FF' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M12 8H12.01' stroke='#3388FF' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
}
  ...
  return (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M12 9V13' stroke='#DE9502' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M12 17H12.01' stroke='#DE9502' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
}
...
function ErrorIcon() {
  return (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path d='M15 9L9 15' stroke='#E51429' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M9 9L15 15' stroke='#E51429' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
}
...
function CloseIcon() {
  return (
    <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <path d='M12 4L4 12' stroke='#333333' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M4 4L12 12' stroke='#333333' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  );
}
