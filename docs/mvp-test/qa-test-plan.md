...
|-----|---------|-------------|
| **Dev (primary)** | `https://vms-dev.torontojs.com` | `https://volunteer-dev.torontojs.com` |
| **Production (final smoke)** | `https://vms.torontojs.com` | `https://volunteer.torontojs.com` |
...
| Critical bugs | 0 |
| Major bugs | 0 |
| Smoke pass rate (R1 + R4) | 100% |
| Full pass rate (R2) | ≥95% executed |
